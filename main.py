...
parser = argparse.ArgumentParser(
    description="EasyOCR image reader. It gets text from image to text file."
)
...
parser.add_argument(
    ...
    help='Option, would it use GPU or not. Default is "--use_gpu"',
)
...
def main():
    ...
    print(
        f"Содержимое изображения {arguments.input_image} "
